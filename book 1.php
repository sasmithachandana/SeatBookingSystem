...
<body>
	 <form class="myform" action="book 1.php" method="post">
	 ...
	 <?php
	   if(isset($_POST['login']))
	   {
			...
			$query2="select * from customer WHERE seatno='1'";
			$query_run=mysqli_query($con,$query2);
			  ...
			  {
			  $query="INSERT INTO customer(seatno,firstname,lastname,nic,email,phone) VALUES ('1','$firstname','$lastname','$nic','$email','$phone')";
