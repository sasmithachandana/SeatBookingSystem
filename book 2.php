...
<body>
	 <form class="myform" action="book 2.php" method="post">
	 ...
	 <?php
	   if(isset($_POST['login']))
	   {
			...
			$query2="select * from customer WHERE seatno='2'";
			$query_run=mysqli_query($con,$query2);
			  ...
			  {
			  $query="INSERT INTO customer(seatno,firstname,lastname,nic,email,phone) VALUES ('2','$firstname','$lastname','$nic','$email','$phone')";
